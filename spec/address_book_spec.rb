...
describe "#remove_entry" do
  ...
  it "imports the 1st entry" do
   ...
   check_entry(entry_one, "Josh", "847-677-6807", "joshyjosh@josh.com")
    end
   ...
   check_entry(entry_two, "Hass", "555-555-5415", "mhass@harvard.edu")
    end
  ...
  it "imports the 3rd entry" do
   ...
   check_entry(entry_three, "Joe", "555-555-5555", "joesmith@gmail.com")
    end
  end
end
